...
static JButton admin= new JButton("ADMIN");
 ...
 static JFrame home=new JFrame("Retail Shop Management");
 ImageIcon img= new ImageIcon(getClass().getResource("Retailshop2.png"));
 JLabel l1=new JLabel("Retail Shop Management System");
 JLabel l2=new JLabel(img);
 static Font jf= new Font("Arial",Font.BOLD+Font.HANGING_BASELINE,18);
 RetailShopManagement(){
  home.setLayout(null);
   ...
   l1.setHorizontalAlignment(javax.swing.JLabel.CENTER);
     l2.add(bill);
     l2.add(l1);
     l1.setFont(new Font("Arial",Font.BOLD,44));
